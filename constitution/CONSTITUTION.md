...
この文書は、ProtoType の開発組織における最上位 contract です。
...
ProtoType の開発組織の目的は current procedure への服従ではありません。
...
ProtoType is a React/Vite typing-game application. Existing package-manager and product architecture decisions remain project-specific authority.
